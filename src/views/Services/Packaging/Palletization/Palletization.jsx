  ...
  return (
    <div className='packaging-palletizing-container'>
        ...
        <div className='packaging-palletizing-body'>
            ...
            <div className='packaging-palletizing-info'>
                ...
                <img 
                    src={images.palletizingBody}
                    alt='animation of a palletizing machine'
                />
                <h2>Our Palletization Capabilities</h2>
                <ul>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Robotic Palletizing:</span> Automation companies offer robotic arms specifically designed 
                        for palletizing tasks, capable of high-speed and precision stacking of various product types.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Palletizing Cells:</span> Customizable palletizing cells that can be integrated into existing 
                        production lines to automate the stacking of products onto pallets.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Software Integration:</span> Integration with Warehouse Management Systems (WMS) or Manufacturing 
                        Execution Systems (MES) to streamline the flow of information and optimize palletizing operations.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Pallet and Load Handling:</span> Automated systems for handling and transferring pallets and loaded products 
                        to and from the palletizing area, reducing manual handling and increasing efficiency.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Layer Forming:</span> Automated equipment and software to arrange products into stable, uniform layers before 
                        they are palletized.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Pallet Dispensing:</span> Machines that automatically dispense empty pallets into the palletizing area, ensuring 
                        a constant supply for continuous operation.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Conveyor Systems:</span> Conveyor systems to transport products to and from the palletizing area, often integrated 
                        with sorting and orienting systems to arrange products correctly before palletizing.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Vision Systems:</span> Integration of vision systems to ensure accurate placement of products, detect errors, and 
                        verify pallet loads.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>End-of-Arm Tooling:</span> Custom-designed grippers, clamps, or vacuum systems at the end of robotic arms to handle 
                        a variety of products securely and safely.
                    </li>
                    <li>
                        <span className='packaging-palletizing-info-bold'>Safety Systems:</span> Integration of safety features such as light curtains, safety scanners, and barrier guards 
