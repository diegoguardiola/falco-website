    ...
    <div className='food-and-bev-packaging-container'>
        ...
        <div className="side-nav">
            ...
            <div className='food-and-bev-packaging-info'>
                ...
                <ul>
                    <li><span className='food-and-bev-packaging-info-bold'>Precision Robotics:</span>
                    ...
                    <li><span className='food-and-bev-packaging-info-bold'>Customized Workstations:</span>
                    ...
                    <li><span className='food-and-bev-packaging-info-bold'>Automated Assembly Lines:</span>
                    ...
                    <li><span className='food-and-bev-packaging-info-bold'> Quality Control Systems:</span>
                    ...
                    <li><span className='food-and-bev-packaging-info-bold'>Integration Services:</span>
                    ...
                    <li><span className='food-and-bev-packaging-info-bold'>Compliance and Safety:</span>
